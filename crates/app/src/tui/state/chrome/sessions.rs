...
impl WorkbenchState {
    ...
    pub(crate) fn remove_session_optimistic(&mut self, session_id: &str) {
        ...
        self.active_session_id = self
            ...
            .map(|entry| entry.session.id.clone());
        self.requests.clear();
        self.request_indices_by_id.clear();
        self.request_tree_metas.clear();
        self.request_route_descendant_counts.clear();
        self.filtered_request_indices.clear();
        self.filtered_request_rows.clear();
        self.filtered_request_positions_by_id.clear();
        self.filtered_route_descendant_counts.clear();
        self.request_stats = RequestStats::default();
        self.live_watermarks = LiveWatermarks::default();
        ...
        self.filtered_console_positions_by_id.clear();
        self.console_stats = ConsoleStats::default();
        self.console_detail_line_cache.replace(None);
        self.websocket_frames.clear();
        self.filtered_websocket_indices.clear();
        self.filtered_websocket_positions_by_id.clear();
        self.websocket_detail_line_cache.replace(None);
        self.websocket_stats = WebSocketStats::default();
        self.websocket_connection_ids.clear();
